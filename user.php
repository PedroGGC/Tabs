                ...
                <?php if ($isOwnProfile): ?>
                    <a class="user-profile-avatar-link" href="profile.php">
                        <?php if (!empty($profileUser['avatar'])): ?>
                            <img class="avatar avatar-xl" src="<?= e((string) $profileUser['avatar']); ?>" alt="Avatar de <?= e((string) $profileUser['username']); ?>">
                        <?php else: ?>
                            <span class="avatar avatar-xl avatar-fallback"><?= e(usernameInitial((string) $profileUser['username'])); ?></span>
                        <?php endif; ?>
                    </a>
                <?php else: ?>
                    <?php if (!empty($profileUser['avatar'])): ?>
