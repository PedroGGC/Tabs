        ...
        <main class="container page-shell">
            ...
            <?php else: ?>
                <article class="card post-full">
                    <h1><?= parsePostContent((string) $post['title']); ?></h1>
                    <div class="meta author-row">
                        <a class="author-link" href="user.php?id=<?= (int) $post['author_id']; ?>" data-transition="up">
                            <?php if (!empty($post['author_avatar'])): ?>
                                <img class="avatar avatar-sm" src="<?= e(assetPath((string) $post['author_avatar'])); ?>"
                    ...
                    <?php if (!empty($post['cover_image'])): ?>
                        <div class="post-cover-wrap">
                            <img class="cover-blur" aria-hidden="true" src="<?= e(assetPath((string) $post['cover_image'])); ?>" alt="">
                            <img class="post-cover post-cover-full cover-main" src="<?= e(assetPath((string) $post['cover_image'])); ?>"
                                alt="Imagem de capa de <?= e((string) $post['title']); ?>">
                        </div>
                    <?php endif; ?>
                    <div class="post-content">
                        <?= parsePostContent((string) $post['content']); ?>
                    </div>
                    ...
                    <?php if ($currentUserId !== null && (int) $post['author_id'] === $currentUserId): ?>
                        <div class="actions-row" style="margin-top:1rem;">
                            <a class="action-link" href="post_manage.php?action=edit&id=<?= (int) $post['id']; ?>"
                ...
                <section class="card post-full" id="comments">
                    ...
                    <?php if (isLogged()): ?>
                        ...
                        <?php else: ?>
                            ...
                            <form method="post" action="src/actions/comments.php?action=store" class="comment-form" id="real-comment-form"
                                style="display: none;">
                                <?= csrfInput(); ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="meta">Faça <a href="../auth/login.php" data-transition="up">login</a> para comentar.</p>
                    <?php endif; ?>
                                ...
                                <article class="comment-item" id="<?= $commentAnchor; ?>">
                                    <a class="author-avatar-link" href="user.php?id=<?= (int) $comment['comment_user_id']; ?>"
                                        ...
                                        <?php if (!empty($comment['comment_author_avatar'])): ?>
                                            <img class="avatar avatar-sm" src="<?= e(assetPath((string) $comment['comment_author_avatar'])); ?>"
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <?php if ($isOwn && isset($_GET['edit_comment']) && (int) $_GET['edit_comment'] === (int) $comment['id']): ?>
                                            <form method="post" action="src/actions/comments.php?action=update&id=<?= (int) $comment['id']; ?>"
                                                class="comment-form">
                                                <?= csrfInput(); ?>
                                                ...
                                                <div class="actions-row">
                                                    ...
                                                    <a class="secondary button-outline"
                                                        href="post_view.php?id=<?= (int) $postId; ?>#<?= $commentAnchor; ?>">Cancelar</a>
                                                </div>
...
<p class="comment-content" id="comment-text-<?= (int) $comment['id']; ?>"><?= nl2br(trim(e((string) $comment['content']))); ?></p>
                                        ...
                                        <?php if (isLogged()): ?>
                                            <form method="post" action="src/actions/comments.php?action=store" class="comment-form reply-form"
    ...
    <script>
        ...
        function openCommentDeleteModal(commentId) {
            ...
            form.action = 'src/actions/comments.php?action=delete&id=' + commentId;
