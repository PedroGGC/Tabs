...
require_once __DIR__ . '/../src/core/post-functions.php';
        ...
        <main class="container page-shell">
            <?php if ($action === 'create'): ?>
                <section class="card form-card">
                    ...
                    <form method="post" action="post_manage.php?action=create" enctype="multipart/form-data">
                        <?= csrfInput(); ?>
            ...
            <?php elseif ($action === 'edit'): ?>
                <section class="card form-card">
                    ...
                    <form method="post" action="post_manage.php?action=edit&id=<?= (int) $postId; ?>" data-transition="down"
                        ...
                        <?php if ($post !== null && !empty($post['cover_image'])): ?>
                            ...
                            <img src="<?= e(assetPath((string) $post['cover_image'])); ?>" alt="Imagem de capa atual" class="cover-preview"
                                loading="lazy">
            ...
            <?php else: ?>
                <section class="card form-card">
                    ...
                    <form method="post" action="post_manage.php?action=delete&id=<?= (int) $postId; ?>" class="actions-row">
                        <?= csrfInput(); ?>
