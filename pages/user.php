                    ...
                    <?php if ($isOwnProfile): ?>
                        <a class="user-profile-avatar-link" href="profile.php">
                            <?php if (!empty($profileUser['avatar'])): ?>
                                <img class="avatar avatar-xl" src="<?= e(assetPath((string) $profileUser['avatar'])); ?>"
                ...
                <?php if ($isOwnProfile): ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($posts as $myPost): ?>
                                            <tr>
                                                <td>
                                                    <a
                                                        href="post_view.php?id=<?= (int) $myPost['id']; ?>"><?= parsePostContent((string) $myPost['title']); ?></a>
                                                </td>
                                                <td><?= e(formatDate((string) $myPost['created_at'])); ?></td>
                                                <td>
                                                    <div class="actions-row">
                                                        <a class="action-link"
                                                            href="post_manage.php?action=edit&id=<?= (int) $myPost['id']; ?>"
                    ...
                    <div id="deleteModal" class="modal" aria-hidden="true" role="dialog" aria-labelledby="deleteModalTitle">
                        <div class="modal-content card">
                            ...
                            <form method="post" action="post_manage.php?action=delete">
                                <?= csrfInput(); ?>
                    ...
                    <div class="posts-grid">
                        <?php foreach ($posts as $post): ?>
                            <article class="card post-card post-card-clickable">
                                <a class="post-card-link" href="post_view.php?id=<?= (int) $post['id']; ?>"
                                ...
                                <h2><?= parsePostContent((string) $post['title']); ?></h2>
